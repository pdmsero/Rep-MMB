...
interest   = 100*log(R_nom/STEADY_STATE(R_nom));                                                 //*
inflation  = 100*log(Pi_CPI_ann/STEADY_STATE(Pi_CPI_ann));                                                    //*
inflationq = 100*log(Pi_CPI/STEADY_STATE(Pi_CPI))*4;                                                  //*
outputgap  = output_gap;                                            //*
output     = 100*log(N/STEADY_STATE(N));  
