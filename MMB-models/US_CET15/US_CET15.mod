...
// “Understanding the Great Recession.” American Economic Journal: Macroeconomics (1): 110-167.                                            
...
//**************************************************************************
// Modelbase Variables                                                   //*    
   interestR inflationR inflationqR outputgapR outputR 		                //*
   interestF inflationF inflationqF outputgapF outputF 		                //*
   interest inflation inflationq outputgap output; 		                //*
//**************************************************************************

%Shocks
varexo muz_eps mupsi_eps
//**************************************************************************
// Modelbase Shocks                                                      //*       
       interest_; 		                                                 //*
//************************************************************************** 
...
sig_eta =1;                                                             % stddev. of technology innovation in technology
...
interestR =   cofintintb1*interestR(-1)                                    //* 
           + cofintintb2*interestR(-2)                                    //* 
           + cofintintb3*interestR(-3)                                    //* 
           + cofintintb4*interestR(-4)                                    //* 
           + cofintinf0*inflationqR                                       //* 
           + cofintinfb1*inflationqR(-1)                                  //* 
           + cofintinfb2*inflationqR(-2)                                  //* 
           + cofintinfb3*inflationqR(-3)                                  //* 
           + cofintinfb4*inflationqR(-4)                                  //* 
           + cofintinff1*inflationqR(+1)                                  //* 
           + cofintinff2*inflationqR(+2)                                  //* 
           + cofintinff3*inflationqR(+3)                                  //* 
           + cofintinff4*inflationqR(+4)                                  //* 
           + cofintout*outputgapR 	                                     //* 
           + cofintoutb1*outputgapR(-1)                                   //* 
           + cofintoutb2*outputgapR(-2)                                   //* 
           + cofintoutb3*outputgapR(-3)                                   //* 
           + cofintoutb4*outputgapR(-4)                                   //* 
           + cofintoutf1*outputgapR(+1)                                   //* 
           + cofintoutf2*outputgapR(+2)                                   //* 
           + cofintoutf3*outputgapR(+3)                                   //* 
           + cofintoutf4*outputgapR(+4)                                   //* 
           + cofintoutp*outputR 	                                         //* 
           + cofintoutpb1*outputR(-1)                                     //* 
           + cofintoutpb2*outputR(-2)                                     //* 
           + cofintoutpb3*outputR(-3)                                     //* 
           + cofintoutpb4*outputR(-4)                                     //* 
           + cofintoutpf1*outputR(+1)                                     //* 
           + cofintoutpf2*outputR(+2)                                     //* 
           + cofintoutpf3*outputR(+3)                                     //* 
           + cofintoutpf4*outputR(+4)                                     //* 
           + std_r_ *interest_;                                          //* 
                                                                         //*

interestF =   cofintintb1*interestF(-1)                                    //* 
           + cofintintb2*interestF(-2)                                    //* 
           + cofintintb3*interestF(-3)                                    //* 
           + cofintintb4*interestF(-4)                                    //* 
           + cofintinf0*inflationqF                                       //* 
           + cofintinfb1*inflationqF(-1)                                  //* 
           + cofintinfb2*inflationqF(-2)                                  //* 
           + cofintinfb3*inflationqF(-3)                                  //* 
           + cofintinfb4*inflationqF(-4)                                  //* 
           + cofintinff1*inflationqF(+1)                                  //* 
           + cofintinff2*inflationqF(+2)                                  //* 
           + cofintinff3*inflationqF(+3)                                  //* 
           + cofintinff4*inflationqF(+4)                                  //* 
           + cofintout*outputgapF 	                                     //* 
           + cofintoutb1*outputgapF(-1)                                   //* 
           + cofintoutb2*outputgapF(-2)                                   //* 
           + cofintoutb3*outputgapF(-3)                                   //* 
           + cofintoutb4*outputgapF(-4)                                   //* 
           + cofintoutf1*outputgapF(+1)                                   //* 
           + cofintoutf2*outputgapF(+2)                                   //* 
           + cofintoutf3*outputgapF(+3)                                   //* 
           + cofintoutf4*outputgapF(+4)                                   //* 
           + cofintoutp*outputF 	                                         //* 
           + cofintoutpb1*outputF(-1)                                     //* 
           + cofintoutpb2*outputF(-2)                                     //* 
           + cofintoutpb3*outputF(-3)                                     //* 
           + cofintoutpb4*outputF(-4)                                     //* 
           + cofintoutpf1*outputF(+1)                                     //* 
           + cofintoutpf2*outputF(+2)                                     //* 
           + cofintoutpf3*outputF(+3)                                     //* 
           + cofintoutpf4*outputF(+4);                                     //* 
// Monetary Policy                                                       //*
                                                                         //*
                                                                         //*
//**************************************************************************
...
%RR=rhoR*RR(-1)+(1-rhoR)*(STEADY_STATE(RR)+rpi/4*(pi4R-STEADY_STATE(pi4R))+rdeltay/4*(GDPR-GDPR(-4)))-sig_epsR*epsR_eps/400;
%RR=rhoR*RR(-1)+(1-rhoR)*(STEADY_STATE(RR)+rpi/4*(pi4R-STEADY_STATE(pi4R))+rdeltay/4*(GDPR-GDPR(-4)))-interest_;
%interest = rhoR*interest(-1)+(1-rhoR)*(rpi/4*inflation+rdeltay/4*(output-output(-4)))-interest_;
...
try;
stoch_simul(order = 1, irf=40,noprint, nograph) interest inflationq inflation output outputgap ;
catch;
end;
