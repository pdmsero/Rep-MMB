...
// The Version presented here includes Tariff Shocks of 10%,PPI targeting equations derived by Z.Abdullayev & L.Schmitz
// PPI Targeting
...
interest   = r*4;                                                      //*
inflation = (1/4)*(4*pih+4*pih(-1)+4*pih(-2)+4*pih(-3));			         //*
inflationq  = pih*4;                                                    //*
outputgap  = x;                                                      //*
output = y;                                                          //*
//**************************************************************************
